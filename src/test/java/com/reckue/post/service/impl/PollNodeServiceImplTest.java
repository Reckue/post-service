...
/**
 * Class PollNodeServiceImplTest represents test for PollNodeService class.
 *
 * @author Viktor Grigoriev
 */
public class PollNodeServiceImplTest extends PostServiceApplicationTests {

    @Mock
    private PollNodeRepository pollNodeRepository;

    @InjectMocks
    private PollNodeServiceImpl pollNodeService;
