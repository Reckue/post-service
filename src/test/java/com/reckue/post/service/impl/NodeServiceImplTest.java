//package com.reckue.post.service.realizations;
//
...
//
///**
// * Class NodeServiceImplTest represents test for NodeService class.
// *
// * @author Iveri Narozashvili
// */
//public class NodeServiceImplTest extends PostServiceApplicationTests {
//
//    @Mock
...
//
//        when(nodeRepository.findAll().stream()
//            .map(e -> (List<?>) e)
//            .collect(Collectors.toList())).thenReturn(posts);
//
